...
class StorageBase():
    ...
    async def getAccounts(self):
        try:
            return self.conn.execute('SELECT * FROM accs').fetchall()
        except Exception as e:
            return e
    ...
    async def getTexts(self, phone):
        try:
            return self.conn.execute('SELECT * FROM texts WHERE phone = ?', (phone,)).fetchall()
        except Exception as e:
            return e
    ...
    async def getInterval(self, phone):
        try:
            return self.conn.execute('SELECT * FROM interval WHERE phone = ?', (phone,)).fetchall()
        except Exception as e:
            return e
...
async def deleteAcc(phone):
    try:
        os.remove(f"./sess/{phone}.session")
    except:
        pass
